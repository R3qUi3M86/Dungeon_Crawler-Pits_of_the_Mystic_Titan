...
all_sounds = [weapon_pickup, ammo_pickup, consumable_pickup, coin_01, coin_02, coin_03, consumable_artifact_use, consumable_potion_use, hero_melee_miss_sound,hero_melee_hit_sound,monster_melee_miss_sound,monster_melee_hit_sound,crossbow_attack_sound,crossbow_bolt_hit_sound,player_pain_sound,player_death_sound,player_overkill_sound1,player_overkill_sound2,player_overkill_sound3,ettin_noise1_sound,ettin_pain_sound,ettin_death_sound,ettin_overkill_sound, bishop_magic_missile_attack_sound,bishop_magic_missile_hit_sound,bishop_noise1_sound,bishop_noise2_sound,bishop_pain_sound,bishop_death_sound,bishop_overkill_sound,bishop_atkprep_sound,bishop_tele_blur_sound]
