...
ammo_runic_font = pygame.font.Font("fonts/ComicRunes.ttf",34)
pickup_runic_font = pygame.font.Font("fonts/DsRunenglish2-nR5O.ttf",18)
...
def display_ammo_runic_text(text, color="Red", x = 10, y = 10):
    text_surf = ammo_runic_font.render(text,True,color)
    text_rect = text_surf.get_rect(topleft = (x,y))
    screen.blit(text_surf,text_rect)

def display_pickup_runic_text(text, color="Red", x = 10, y = 10):
    text_surf = pickup_runic_font.render(text,True,color)
