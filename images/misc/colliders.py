...
###### Entity #####
###################
melee_collider_e = pygame.image.load("images/misc/colliders/melee_sector_e.png").convert_alpha()
melee_collider_ne = pygame.image.load("images/misc/colliders/melee_sector_ne.png").convert_alpha()
melee_collider_n = pygame.image.load("images/misc/colliders/melee_sector_n.png").convert_alpha()
melee_collider_nw = pygame.image.load("images/misc/colliders/melee_sector_nw.png").convert_alpha()
melee_collider_w = pygame.image.load("images/misc/colliders/melee_sector_w.png").convert_alpha()
melee_collider_sw = pygame.image.load("images/misc/colliders/melee_sector_sw.png").convert_alpha()
