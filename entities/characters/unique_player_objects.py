...
PLAYER_COLISION_MASK_NW = shadow.Shadow(player_position, PLAYER_SHADOW_ID, SIZE_SMALL, False, SECTOR_NW)
PLAYER_COLISION_MASK_NE = shadow.Shadow(player_position, PLAYER_SHADOW_ID, SIZE_SMALL, False, SECTOR_NE)
PLAYER_COLISION_MASK_SW = shadow.Shadow(player_position, PLAYER_SHADOW_ID, SIZE_SMALL, False, SECTOR_SW)
PLAYER_COLISION_MASK_SE = shadow.Shadow(player_position, PLAYER_SHADOW_ID, SIZE_SMALL, False, SECTOR_SE)