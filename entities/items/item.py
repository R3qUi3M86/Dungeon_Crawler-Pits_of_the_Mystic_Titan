...
WEAPON_DAMAGE_DICT = {SWORD:2, EMERALD_CROSSBOW:2, NECROLIGHT:15, ETTIN_MACE:1, BISHOP_MAGIC_MISSILE:1, SPIKE_BALL_SPELL:5, WHIRLWIND_SPELL:1, RED_ORB_SPELL:8}
...
WEAPON_ATTACK_SPEED_DICT = {SWORD:3, EMERALD_CROSSBOW:3, NECROLIGHT:8, ETTIN_MACE:10, BISHOP_MAGIC_MISSILE:3, SPIKE_BALL_SPELL:3.5, WHIRLWIND_SPELL:3.5, RED_ORB_SPELL:3.5}
WEAPON_ATTACK_COOLDOWN_DICT = {SWORD:0, EMERALD_CROSSBOW:1.2, NECROLIGHT:0.22, ETTIN_MACE:0, BISHOP_MAGIC_MISSILE:3.5, SPIKE_BALL_SPELL:3, WHIRLWIND_SPELL:4, RED_ORB_SPELL:6}
...
class Item(pygame.sprite.Sprite):
    ...
    def increment_item_cooldown_timer(self):
        if not self.is_ready_to_use:
            if self.is_weapon:
                self.use_cooldown += 0.02 * t_ctrl.dt
    ...
    def increment_chainfire_cooldown(self):
        self.chainfire_cooldown += 0.02 * t_ctrl.dt